...
class GPFinal(GenericProgramming):
    ...
    def selection(self):
        ...
        winner = []
        idx_list = [i for i in range(len(fitness_list))]
        ...
        return [self.population[idx].copy() for idx in winner]
    ...
    def next_population1(self, preserve_num) -> None:
        top_individual_list = self.get_bottom_individual_list(preserve_num)
